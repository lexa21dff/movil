...
public class crearProyecto extends AppCompatActivity {
    private EditText et_nombre,et_descripcion,et_estado;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_crear_proyecto);
        et_nombre= (EditText) findViewById(R.id.edi1);
        et_descripcion= (EditText) findViewById(R.id.edi2);
        et_estado = (EditText) findViewById(R.id.edi3);
    }
